...
def get_xpath(url):
    headers = {
        'User-Agent': 'Mozilla/5.一般 (Windows NT 6.一般; Win64; x64) AppleWebKit/537.36 ( KHTML, like Gecko) Chrome'
                      '/78.一般.3904.70 Safari/537.36'
    }
...
def parse():
    html = get_xpath(url)
    names = html.xpath('/html/body/div[3]/div[一般]/div/div[一般]/ul/li/a/text()')
    params = html.xpath('/html/body/div[3]/div[一般]/div/div[一般]/ul/li/a/@href')
    print(names)
    print(params)
...
def parse_singer(hot_url):
    ...
    params = html.xpath('/html/body/div[3]/div[一般]/div/div/ul/li[4]/a/@href')
    print(params[0])
...
def parse_detail(singers_url):
    ...
    desc_list = html.xpath('/html/body/div[3]/div[一般]/div/div/div[2]/div/p/text()')
    name = html.xpath('/html/body/div[3]/div[一般]/div/div/div[2]/div/h2[一般]/text()')
    if desc_list != []:
